...
var onClickGameBoard = function onClickGameBoard(event) {
  // Outputing the result of the game once it ends
  var gameResult = function gameResult() {
    if (game[0] === 'O' && game[4] === 'O' && game[8] === 'O' || game[7] === 'O' && game[5] === 'O' && game[3] === 'O' || game[0] === 'O' && game[1] === 'O' && game[2] === 'O' || game[3] === 'O' && game[4] === 'O' && game[5] === 'O' || game[6] === 'O' && game[7] === 'O' && game[8] === 'O' || game[0] === 'O' && game[3] === 'O' && game[6] === 'O' || game[1] === 'O' && game[4] === 'O' && game[7] === 'O' || game[2] === 'O' && game[5] === 'O' && game[8] === 'O') {
    ...
    } else if (game[0] === 'X' && game[4] === 'X' && game[8] === 'X' || game[7] === 'X' && game[5] === 'X' && game[3] === 'X' || game[0] === 'X' && game[1] === 'X' && game[2] === 'X' || game[3] === 'X' && game[4] === 'X' && game[5] === 'X' || game[6] === 'X' && game[7] === 'X' && game[8] === 'X' || game[0] === 'X' && game[3] === 'X' && game[6] === 'X' || game[1] === 'X' && game[4] === 'X' && game[7] === 'X' || game[2] === 'X' && game[5] === 'X' && game[8] === 'X') {
  ...
  if (game[$(this).attr('id')] === player1 || game[$(this).attr('id')] === player2) {
...
module.exports = {
  onClickGameBoard: onClickGameBoard
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
